...
public class APIController {
	...
	@GetMapping("/{category}")
	public ResponseEntity<List<RequiredDataDTO>> getListbyCategoryHandler(@PathVariable String category) throws APIFetchingException{
	...
	@PostMapping("/add")
	public ResponseEntity<Entry> addEntryHandler(@RequestBody Entry entry) throws APIFetchingException{
